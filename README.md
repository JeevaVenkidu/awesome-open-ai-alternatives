...
| **Hivekeep** | Run a team of specialized AI agents with persistent memory, a web UI, and Telegram/Slack/Discord/Matrix channels | [![GitHub stars](https://img.shields.io/github/stars/MarlBurroW/hivekeep?style=social)](https://github.com/MarlBurroW/hivekeep) | Single-container agent team (Bun + SQLite) | [![License](https://img.shields.io/github/license/MarlBurroW/hivekeep.svg)](https://github.com/MarlBurroW/hivekeep) | Self-Hostable ✅ |
| **Orkas** | Local-first desktop AI workforce coordinated through one conversation | [![GitHub stars](https://img.shields.io/github/stars/Orkas-AI/Orkas?style=social)](https://github.com/Orkas-AI/Orkas) | Commander-led specialist agents | [![License](https://img.shields.io/github/license/Orkas-AI/Orkas.svg)](https://github.com/Orkas-AI/Orkas) | Self-Hostable ✅ |
